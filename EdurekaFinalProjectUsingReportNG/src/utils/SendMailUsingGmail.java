...
public class SendMailUsingGmail {
	...
	public static void sendMail(String resultfilename) {
		// get the session object that contains all the information of host like
		// hostname, username and password
		// we can get the session object by using the
		// getDefaultInstance(Properties) or getInstance(Properties)
		// Compose the message
